...
class UserBehavior(TaskSet):
    ...
    def audio(self):
        ...
        response = self.client.post("/classify/audio_sing", data=data, files={'file': raw_audio})
    ...
    def blzy(self):
        ...
        response = self.client.post("/game/blzy_digit", data=data, files={'file': raw_blzy})
        print("{}: {}".format(response.status_code, response.text))
    ...
    def cjzc(self):
        ...
        response = self.client.post("/classify/cjzc_chiji", data=data, files={'file': raw_cjzc})
        print("{}: {}".format(response.status_code, response.text))
        response = self.client.post("/classify/cjzc_sipai", data=data, files={'file': raw_cjzc})
        print("{}: {}".format(response.status_code, response.text))
    ...
    def gok(self):
        ...
        response = self.client.post("/game/gok_digit_fast", data=data, files={'file': raw_gok})
        print("{}: {}".format(response.status_code, response.text))
    ...
    def lol(self):
        ...
        response = self.client.post("/classify/lolend", data=data, files={'file': raw_lol})
        print("{}: {}".format(response.status_code, response.text))
    ...
    def nsh(self):
        data = {"contents": "hero", "dtype": "image", "pid": 911}
        response = self.client.post("/game/nsh_profession", data=data, files={'file': raw_nsh})
        print("{}: {}".format(response.status_code, response.text))
    ...
    def pubg(self):
        data = {"contents": "digit,state", "dtype": "image", "pid": 911}
        response = self.client.post("/classify/pubg_state", data=data, files={'file': raw_pubg})
        print("{}: {}".format(response.status_code, response.text))
        response = self.client.post("/game/pubg_digit", data=data, files={'file': raw_pubg})
        print("{}: {}".format(response.status_code, response.text))
        response = self.client.post("/game/pubg_down_kill", data=data, files={'file': raw_pubg})
        print("{}: {}".format(response.status_code, response.text))
        response = self.client.post("/game/pubg_live", data=data, files={'file': raw_pubg})
        print("{}: {}".format(response.status_code, response.text))
    ...
    def qjcj(self):
        data = {"contents": "digit,state", "dtype": "image", "pid": 911}
        response = self.client.post("/game/qjcj_digit", data=data, files={'file': raw_qjcj})
        print("{}: {}".format(response.status_code, response.text))
        response = self.client.post("/classify/qjcj_end", data=data, files={'file': raw_qjcj})
        print("{}: {}".format(response.status_code, response.text))
    
    @task(150)
    def qrcode(self):
        data = {"contents": "qrcode", "dtype": "image", "pid": 911}
        response = self.client.post("/classify/qrcode", data=data, files={'file': raw_qrcode})
        print("{}: {}".format(response.status_code, response.text))
    ...
    def xingxiu(self):
        ...
        response = self.client.post("/classify/dance_v2", data=data, files={'file': raw_xingxiu})
        print("{}: {}".format(response.status_code, response.text))
    ...
    def yanzhi(self):
        data = {"contents": "dance", "dtype": "image", "pid": 911}
        response = self.client.post("/classify/yanzhi", data=data, files={'file': raw_yanzhi})
        print("{}: {}".format(response.status_code, response.text))
